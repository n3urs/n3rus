// 💌 ALL the words live in this file. Everything marked [PLACEHOLDER] is for
// Oscar to rewrite — edit this file on GitHub (press "." or the pencil icon)
// and the site updates a minute later.

const NOTES = {
  // Rotating captions under the countdown. {days} becomes the real number.
  captions: [
    "only {days} more sleeps until I see your face 💗",
  ...
  heartClues: {
    h1: "the big heart keeps a little one right beneath it",
    h2: "scroll to the very bottom of where we count…",
    h3: "in the garden, something blooms behind the bushes",
    h4: "plant five flowers and see what else grows",
    h5: "at the mailbox, check the postage twice",
    h6: "a broken seal still holds love",
  },
  ...
  riddle:
    "I'm not baked, but I am sweet —\n" +
    "four strong legs instead of feet.\n" +
    "Hettie feeds me, brushes my hair…\n" +
    "whisper my name, find treasure somewhere. 🗝️",
  ...
  animalLines: {
    ...
    maude: "Maude reporting for duty 🐕💕",
    bee: "Bzzzzz… Bee says hi 🐝",
    mouse: "Mouse!! …being chased, as usual 🐭",
    rosie: "Rosie demands attention. Immediately. 🐱",
    biscuit: "Biscuit trots in like he owns the place 🐴",
    hettie: "HETTIE RANKIN — the most loved girl in the entire world 💗",
  },
};
